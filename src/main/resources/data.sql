...
insert into department(id,department_name) values(1,'GOoD repair department');
insert into department(id,department_name) values(2,'GOoD replacement department');
insert into department(id,department_name) values(3,'GOoD analysis department');
insert into department(id,department_name) values(4,'Test department');